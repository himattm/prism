...
// colorMap caches the map of colors to avoid allocation on every call
...
// This uses a package-level variable to improve performance and avoid
// map allocations on every status line render.
