...
## 2024-10-24 - Precompile Regular Expressions Globally
**Learning:** Calling `regexp.MustCompile` inside frequently executed functions (like discovery loops or parsing headers) forces the Go runtime to recompile the regex on every invocation, causing unnecessary CPU overhead and memory allocations.
