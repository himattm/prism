...
## 2024-05-20 - Pre-compile Regular Expressions
**Learning:** Calling `regexp.MustCompile` inside frequently executed functions (such as discovery loops) causes unnecessary repeated CPU overhead and memory allocations.
