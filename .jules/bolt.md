...
## 2024-06-04 - Avoid regexp.MustCompile in frequently called functions
**Learning:** Compiling regular expressions using `regexp.MustCompile` inside functions called during loops (like plugin discovery or updates) causes redundant CPU overhead and memory allocations.
