...
## 2024-05-23 - Avoid regexp.MustCompile in discovery loops
**Learning:** Compiling regular expressions using `regexp.MustCompile` inside frequently executed functions (like plugin discovery loops) causes unnecessary CPU overhead and memory allocations.
